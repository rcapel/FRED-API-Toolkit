namespace FRED.Api.Core
{
	...
	public static class FREDData
	{
		...
		public enum series_order_by_values { series_id, title, units, frequency, seasonal_adjustment, realtime_start, realtime_end, last_updated, observation_start, observation_end, popularity, group_popularity }
		public enum series_search_order_by_values { search_rank, series_id, title, units, frequency, seasonal_adjustment, realtime_start, realtime_end, last_updated, observation_start, observation_end, popularity, group_popularity }
