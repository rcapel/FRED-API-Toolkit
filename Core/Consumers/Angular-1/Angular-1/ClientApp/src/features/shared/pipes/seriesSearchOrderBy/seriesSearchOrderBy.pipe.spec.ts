import { SeriesSearchOrderByPipe } from './seriesSearchOrderBy.pipe'

describe("SeriesSearchOrderByPipe", () => {
  let pipe;

  beforeEach(() => {
    pipe = new SeriesSearchOrderByPipe;
  });

  it("should return 'search_rank' when value is 0", () => {
    let transformed = pipe.transform(0);

    expect(transformed).toBe("search_rank");
  });
  ...
  it("should return undefined when value is greater than 12", () => {
