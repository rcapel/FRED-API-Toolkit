...
namespace AngularConsumer1.Controllers.Categories
{
	...
	public class CategoryRelatedTagsController : ControllerBase
	{
		#region fields

		private readonly ICategoryRelatedTags api;
		private readonly IAppSettings appSettings;
		private readonly ILogger<CategoryRelatedTagsController> logger;

		#endregion

		#region constructors

		public CategoryRelatedTagsController(
			ICategoryRelatedTags api,
			IAppSettings appSettings,
			ILogger<CategoryRelatedTagsController> logger) : base()
		{
			this.api = api;
			...
			string exclude_tag_names, string tag_group_id, string search_text)
		{
			...
			{
				logger.LogError(exception, "GetCategoryRelatedTags failed");
